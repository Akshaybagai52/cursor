...
const Header = () => {
  ...
  return (
    <header className='flex p-4 justify-center items-center'>
      <Link href={'/'} className='w-full flex justify-left gap-2 items-center '>
                ...
                <li className='row-span-3'>
                  <span
                    className='flex h-full select-none flex-col justify-end rounded-md
                                        bg-gradient-to-b from-muted/50 to-muted p-6
    ...
    <li>
      <NavigationMenuLink asChild>
        ...
        >
          ...
          <p
            className='group-hover:text-white/70 line-clamp-2
